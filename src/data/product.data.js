...
const ProductData = [
  {
    ...
    description: "Available everyday, for any occasions flower arrangement and for anyone too. Mix seasonal flowers arrange in vertical design in green floral foam with square black ceramic vase.",
    fullDescription: "Available everyday, for any occasions flower arrangement and for anyone too. Mix seasonal flowers arrange in vertical design in green floral foam with square black ceramic vase.",
  ...
  },
  {
    ...
    description: "Specially made hand bouquet style a perfect gift to friend, family, colleague or to the love one. A beautiful mix flowers with tied up as a bouquet or keep it in the clear glass vase.",
    fullDescription: "Specially made hand bouquet style a perfect gift to friend, family, colleague or to the love one. A beautiful mix flowers with tied up as a bouquet or keep it in the clear glass vase. The arrangement come with a simple beautiful glass vase included.",
    dimensions: "",
    pricingText: "$39.00",
  ...
  },
  {
    ...
    description: "A cute small hand tied bouquet with several favorite designer choice flowers could a perfect bouquet for graduation girl, bridesmaid, thoughtful and thank you expression. This arrangement come with a simple beautiful glass vase to keep it fresh. ",
    fullDescription: "",
  ...
  },
  {
    ...
    description: "We offer a funeral package of a full set for funeral flower arrangement from table arrangement, cascade, wreath, cross candle, photo framed, and for the last goodbye flower.",
    fullDescription: "We offer a funeral package of a full set for funeral flower arrangement from table arrangement, cascade, wreath, cross candle, photo framed, and for the last goodbye flower.Price may vary depend on the your need and type of flower used.",
    dimensions: "Arizona, RAK",
  ...
  },
  {
    ...
    title: "Phalaenopsis",
    description: "The authentication beauty of Phalaenopsis orchid accessories with other element that fit well and stunning potting in ceramic vase. A classy and elegant gifts. available in two colors: (choose one your color preference).",
    fullDescription: "The authentication beauty of Phalaenopsis orchid accessories with other element that fit well and stunning potting in ceramic vase. A classy and elegant gifts.",
    dimensions: "",
  ...
  },
  {
    ...
    description: "A variety  and unique of succulents that create a beautiful thing to view it  just  like a miniature garden in round ceramic bowl. This  would be a perfect  gift  for a housewarming party, farewell party or use as in home decor.",
    fullDescription: "A variety  and unique of succulents that create a beautiful thing to view it  just  like a miniature garden in round ceramic bowl. This  would be a perfect  gift  for a housewarming party, farewell party or use as in home decor. An easy care and a longer lifetime of these plants could be a favorite choice as a gift  for friends. ",
    dimensions: "",
    pricingText: "$35.00",
