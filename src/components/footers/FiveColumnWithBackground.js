...
import LogoImage from "images/glowing-flower.svg";
import { ReactComponent as FacebookIcon } from "images/facebook-icon.svg";
import { ReactComponent as TwitterIcon } from "images/twitter-icon.svg";
import { ReactComponent as YoutubeIcon } from "images/youtube-icon.svg";
import { ReactComponent as SvgDecoratorBlob1 } from "images/svg-decorator-blob-9.svg";

const Container = tw.div`relative bg-indigo-800 text-gray-100 -mb-8 -mx-8 px-8 py-20 lg:py-24`;
    ...
    <Container>
      <Content>
        ...
        <ThreeColRow>
          ...
          <CopywrightNotice>&copy; 2021 Chandra Tanuwijayua, website by
          <a href="https://oscarluna.dev" target="_blank" rel="noopener noreferrer">Oscar Armando Luna</a>
          </CopywrightNotice>
