...
const ThreeColumnContainer = styled.div`
  ${tw`flex flex-col items-center justify-around text-center md:items-stretch md:flex-row flex-wrap md:justify-center max-w-screen-lg mx-auto py-20 md:py-24`}
`;
