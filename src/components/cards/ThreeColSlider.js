...
const TextInfo = tw.div`py-6 sm:px-10 sm:py-6 text-indigo-900 text-lg`;
...
const Description = tw.p`text-sm font-normal text-indigo-900 leading-loose mt-2 sm:mt-4`;
const SecondaryInfoContainer = tw.div`flex flex-col sm:flex-row mt-2 sm:mt-4`;
const IconWithText = tw.div`flex items-center mr-6 my-2 sm:my-0`;
const IconContainer = styled.div`
  ${tw`inline-block rounded-full p-2 bg-indigo-200 text-indigo-900`}
  svg {
    ${tw`w-3 h-3`}
  }
`;
const Text = tw.div`ml-2 text-sm font-semibold text-indigo-900`;

const PrimaryButton = tw(PrimaryButtonBase)`mt-auto sm:text-lg rounded-none w-full rounded sm:rounded-none sm:rounded-br-4xl py-3 sm:py-6 bg-indigo-900 hover:bg-indigo-700`;
export default () => {
