...
const imageSrc = `https://images.pexels.com/photos/934011/pexels-photo-934011.jpeg?auto=compress&cs=tinysrgb&w=1600`
...
const CardType = tw.div`font-semibold text-sm text-indigo-600`;

const CardTitle = tw.h5`text-xl mt-4 font-bold`;

const CardMeta = styled.div`
  ${tw`flex flex-row flex-wrap justify-center sm:items-center font-semibold tracking-wide text-indigo-600 uppercase text-xs`}
`;
...
export default ({
  ...
  headingHtmlComponent = (
    <>
      We've done some <span tw="text-indigo-500">amazing projects.</span>
    </>
  ),
