...
const Header = tw.header`
  ...
  max-w-screen-xl flex-nowrap mx-auto sm:bg-transparent md:bg-transparent text-indigo-900 z-10
`;

export const NavLinks = tw.div`inline-block justify-evenly z-50!`;

/* hocus: stands for "on hover or focus"
 * hocus:bg-indigo-900 will apply the bg-indigo-900 class on hover or focus
 */
export const NavLink = tw.a`
  text-lg my-2 lg:text-lg lg:ml-1 lg:mr-5 lg:my-0
...
export default connect(mapStateToProps, mapDispatchToProps)(({ roundedHeaderButton = false, logoLink, links, className, currentUser, hidden, signOutStart, collapseBreakpointClass = "lg" }) => {
  /*
  ...
  const defaultLinks = [
    ...
    {hidden ? null : <CartDropdown />}
      {currentUser ? (
        ...
        <PrimaryLink css={roundedHeaderButton && tw`rounded-full`}>SIGN IN</PrimaryLink>
      )}
      <CartIcon />
