...
const Header = tw.header`
  ...
  max-w-screen-xl flex-nowrap mx-auto sm:bg-transparent md:bg-transparent text-indigo-900 z-50
`;
...
export default connect(mapStateToProps, mapDispatchToProps)(({ roundedHeaderButton = true, logoLink, links, className, currentUser, hidden, emailSignInStart, signOutStart, collapseBreakpointClass = "lg" }) => {
  /*
  ...
  const defaultLinks = [
    ...
    {hidden ? null : <CartDropdown />}
      {currentUser ? (
        ...
        <PrimaryLink css={roundedHeaderButton && tw`rounded-full`} href="/signin" as="button" onClick={emailSignInStart}>SIGN IN</PrimaryLink>
      )}
      <CartIcon />
