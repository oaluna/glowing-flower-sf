...
const PrimaryNavLink = tw(
  NavLink
)`text-gray-100 bg-indigo-500 px-6 py-3 border-none rounded hocus:bg-indigo-900 focus:shadow-outline mt-6 md:mt-4 lg:mt-0`;
...
const ActionButton = tw(
  AnchorLink
)`px-8 py-3 font-bold rounded bg-indigo-500 text-gray-100 hocus:bg-indigo-700 hocus:text-gray-200 focus:shadow-outline focus:outline-none transition duration-300 mt-12 inline-block tracking-wide text-center px-10 py-4 font-semibold tracking-normal`;
